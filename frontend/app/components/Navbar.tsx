    ...
    <nav className="bg-white border-b border-slate-200 sticky top-0 z-50 shadow-sm">
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-8 text-xs font-bold text-slate-700 uppercase tracking-wider">
          ...
          <a href="/#partner-section" className="hover:text-amber-600 transition">Partnership</a>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-b border-slate-200 px-6 py-4 space-y-3 text-xs font-bold uppercase tracking-wider">
          ...
          <a href="/#partner-section" onClick={() => setIsOpen(false)} className="block text-slate-700 hover:text-amber-600 py-1">Partnership</a>
          <div className="pt-3 border-t border-slate-100 flex flex-col gap-2">
            ...
            <a href="/#partner-section" className="w-full py-3 bg-amber-600 text-white font-bold rounded-xl text-center flex items-center justify-center gap-2">
